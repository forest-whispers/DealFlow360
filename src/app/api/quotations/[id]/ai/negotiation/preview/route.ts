...
import { negotiationPreviewService } from "@/server/modules/ai/negotiation/negotiation.preview.service";

/**
 * Supported roles for negotiation preview:
...
export const POST = createRouteHandler(
    async (request: NextRequest, context: { params?: Promise<unknown> }) => {
        ...
        const result = await negotiationPreviewService.previewNegotiationMessage(
            user,
            id,
            body,
            { mockMode },
