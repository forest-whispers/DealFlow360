...
export const FULFILLMENT_READ_ROLES: ("ADMIN" | "SALES_MANAGER" | "SALES_REP" | "FINANCE_OPERATIONS")[] = [
    "ADMIN",
    "FINANCE_OPERATIONS",
    "SALES_MANAGER",
    "SALES_REP",
];
export const FULFILLMENT_CREATE_ROLES: ("ADMIN" | "SALES_MANAGER" | "FINANCE_OPERATIONS")[] = [
    "ADMIN",
    "FINANCE_OPERATIONS",
    "SALES_MANAGER",
];
export const WAREHOUSE_READ_ROLES: ("ADMIN" | "SALES_MANAGER" | "SALES_REP" | "FINANCE_OPERATIONS")[] = [
    "ADMIN",
    "FINANCE_OPERATIONS",
    "SALES_MANAGER",
    "SALES_REP",
